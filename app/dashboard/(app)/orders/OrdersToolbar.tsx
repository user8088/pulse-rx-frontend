      ...
      <div className="flex flex-wrap items-center gap-3 flex-1">
        <div className="relative">
          <input
            ...
            className="h-10 rounded-lg border border-gray-200 px-3 pr-9 text-sm w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-[#01AC28] focus:border-transparent"
          />
          {draft && (
            <button
              type="button"
